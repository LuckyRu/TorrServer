        ...
        "/gst/{hash}/c/{token}/init.mp4": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Session token from master.m3u8",
                        "name": "token",
                        "in": "path",
                        "required": true
                    },
        ...
        "/gst/{hash}/master.m3u8": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Stable device identifier; without one the client is identified by address and user agent, and two devices behind one fingerprint share a pipeline",
                        "name": "client",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "application/vnd.apple.mpegurl playlist; every link below it carries the session token",
                        "schema": {
                            "type": "string"
                        }
                    },
                    ...
                    "503": {
                        "description": "Every session slot is in use",
                        "schema": {
                            "type": "string"
                        }
                    }
